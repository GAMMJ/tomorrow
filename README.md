...
<div class="button-group">
  <button class="gnb-icon-button is-search lg-hidden" type="button" aria-label="검색 창 열기 버튼">
    <i class="ic-search"></i>
  </button>
...
<div class="button-group">
  ...
  <a class="gnb-icon-button sm-hidden" href="/" aria-label="스크랩북 페이지로로 이동">
...
- 로그인을 한 경우 (.sidebar-user)

```html
<div class="sidebar-user">
  <a href="/">
    <div class="avatar-24">
      <img src="./assets/images/img-user-01.jpg" alt="유저 사진" />
    </div>
